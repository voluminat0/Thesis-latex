...
%ADVANTAGES
% Very flexible policies (user defined and can pass different arguments to predicates)
% tradeoff tussen expressiveness en flexibility & verbosity en conciseness
% Not uitdrukken, recursie ook
% Geven exacte informatie bij elke violation/query

\subsection{Limitations}
%LIMITATIONS
% Limited to information of JIPDA graph
% Current implementation support for only 1 negated node at the time
% No means to combine results or take exclusive disjunction


\subsection{Conclusion}
%OUTRO

The combination of abstract state graphs and regular path expressions prove to be an effective means to obtain program information and define security policies. We validated our framework by expressing a wide range of different security policies in the JS-QL language and discussing the advantages and limitations of our approach.
